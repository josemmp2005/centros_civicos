...
export default function Reservas() {
    const { getReservas, crearReserva, cancelarReserva, reservas } = useContext(AuthContext);
    ...
    const handleNuevaReserva = () => {
        ...
        const reservaData = { 
            ...
            fecha_inicio: fechaInicio.replace("T", " ") + ":00", // Ajuste de formato
    ...
    return (
        <div className="reservas-container">
                    ...
                    <tbody>
                        {reservas.map(reserva => (
                            <tr key={reserva.id}>
                                ...
                                <td>{reserva.email}</td>
                                <td>Instalación #{reserva.instalacion_id}</td>
            ...
            <div className="reservas-form">
                ...
                <label>Instalación ID:
                    <input type="text" value={instalacionId} onChange={(e) => setInstalacionId(e.target.value)} />
                </label>
